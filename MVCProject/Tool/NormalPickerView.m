...
@interface NormalPickerView ()<UIPickerViewDelegate,UIPickerViewDataSource>
...
//    [pickerBackView addSubview:sureButton];
    ...
    _pickerView = [[UIPickerView alloc] initWithFrame:CGRectMake(0, 0, kScreenWidth, 250 * kFitHeight)];
...
- (void)clickSureButton
{
    if(_normalPickerView){
        _normalPickerView(self.selectString);
    }
}
